...
ReOneStep(double deltaTimeIncrement)
{
	...
	// print current running SWCs.
	if(torcs_output[CC_TRIGGER] > 0.5 || torcs_output[LKAS_TRIGGER] > 0.5)
	{
		switch(a)
		{
			case 1:
				ReRaceBigMsgSet("Active SWCs: 1", 0.1);
				break;

			case 2:
				ReRaceBigMsgSet("Active SWCs: 2", 0.1);
				break;

			case 3:
				ReRaceBigMsgSet("Active SWCs: 3", 0.1);
				break;

			case 4:
				ReRaceBigMsgSet("Active SWCs: 4", 0.1);
				break;

			case 5:
				ReRaceBigMsgSet("Active SWCs: 5", 0.1);
				break;
